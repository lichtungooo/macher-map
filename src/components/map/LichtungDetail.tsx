    ...
    <div className="fixed z-[1500] rounded-2xl shadow-xl overflow-hidden" style={{ top: '70px', right: '16px', width: '360px', maxHeight: 'calc(100vh - 90px)', background: '#fff', border: '1px solid rgba(10,10,10,0.06)', animation: 'fade-in-up 0.2s ease-out' }}>
      ...
      <div className="overflow-y-auto p-5" style={{ maxHeight: 'calc(100vh - 160px)' }}>
        ...
        <a href={mapsUrl} target="_blank" rel="noopener noreferrer"
          className="flex items-center justify-center gap-2 w-full py-3 rounded-xl mb-5"
        ...
        <div className="flex items-center gap-2 mb-3">
          <CalendarDays size={14} style={{ color: '#7BAE5E' }} />
          <span style={{ ...font, fontSize: '0.72rem', fontWeight: 600, color: '#0A0A0A' }}>Termine an diesem Ort</span>
        </div>
